...
const Certificat = () => {
  ...
  const certificats = [
    ...
    text: 'It has been successfully completed in the Competency Exam organized by Universitas Teknokrat Indonesia in 2023, specifically in the field of Computer Networking & Troubleshooting.', image: '/images/Sertifikat Jaringan Komputer & Troubleshooting.jpeg', 
    link: 'https://drive.google.com/file/d/1rcZy1gC6gXpUCieufgII5EJWwVpeTmWg/view?usp=drive_link' },
    { title: 'Graphic Design', 
    image: '/images/Sertifikat Desain Grafis.jpeg', 
    ...
    { title: 'Mikrotik Training', image: '/images/Sertifikat Pelatihan Mikrotik.jpeg', 
